...
const std::string CLIENT_ID("/mqtt_backend");
...
int main(int argc, char* argv[])
{
	...
	traffic_light::LightMessage light_message("file_name");
	traffic_light::callback cb(client, connOpts, light_message, TOPIC);
